...
If (!$LenovoVantage) {
        ...
        If ($LenovoVantage) {
            ...
            Write-Host "The Lenovo Commercial Vantage Store Package been Successfully Provisioned on this System" -ForegroundColor Green

        } Else {

            Write-Host "The Lenovo Commercial Vantage Store Package Provisioning Process has Failed" -ForegroundColor Red

        }

} Else {
    
    Write-Host "The Lenovo Commercial Vantage Store Microsoft Store Package is already Provisioned on this System" -ForegroundColor Yellow
...
If ($MsVcLibs -and $MsNetRuntime -and $MsNetFramework) {
    ...
    Write-Host "The Lenovo Commercial Vantage Store Microsoft VCLibs v140.00 Dependency is Not Provisioned" -ForegroundColor Yellow

} ElseIf (!$MsNetRuntime) {

    Write-Host "The Lenovo Commercial Vantage Store Microsoft NET Native Runtime v2.2 Dependency is Not Provisioned" -ForegroundColor Yellow

} ElseIf (!$MsNetFramework) {

    Write-Host "The Lenovo Commercial Vantage Store Microsoft NET Native Framework v2.2 Dependency is Not Provisioned" -ForegroundColor Yellow
